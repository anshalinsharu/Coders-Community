            ...
            <div className="bg-white p-8 rounded-lg shadow-md sm:w-full sm:max-w-sm">
                ...
                <form onSubmit={handleSubmit} className="mt-6 space-y-6">
                    ...
                    <div>
                        ...
                        <div className="mt-1">
                            <select onChange={handleInput} name="role"
                                ...
                                <option name="role" value="normaluser">Student</option>
                            </select>
                    ...
                    <div>
                        <button
                            type="submit"
                            className="flex w-full justify-center rounded-md bg-green-500 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-green-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
                        >
                            Register
                        </button>
                    </div>
